...
import { ProfesorInfoComponent } from 'app/entities/profesor-info/profesor-info.component';
...
describe('Component Tests', () => {
  describe('ProfesorInfo Management Component', () => {
    let comp: ProfesorInfoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProfesorInfoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.profesorInfos && comp.profesorInfos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
