...
import { StudentInfoComponent } from 'app/entities/student-info/student-info.component';
...
describe('Component Tests', () => {
  describe('StudentInfo Management Component', () => {
    let comp: StudentInfoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(StudentInfoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.studentInfos && comp.studentInfos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
