...
describe('Service Tests', () => {
  describe('StudentInfo Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(StudentInfoService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new StudentInfo(0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a StudentInfo', () => {
        ...
        service.create(new StudentInfo()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should update a StudentInfo', () => {
        const returnedFromService = Object.assign({}, elemDefault);
      ...
      it('should delete a StudentInfo', () => {
